...
function posicaoRandomica() {
	...
	if(document.getElementById('mosquito')) {
        ...
        if(vidas > 3){
            ...
            document.querySelector('#v' + vidas).src= '/codigo fonte/public/img_jogo_mosquito/coracao_vazio.png'
            vidas++
        }
	...
	mosquito.src = '/codigo fonte/public/img_jogo_mosquito/mosca.png'
